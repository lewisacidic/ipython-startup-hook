...
Thank you for your interest in ipython-startup-hook!
...
Finally, include **operating system type and version**, **Python version**, **ipython-startup-hook version**, and the **installation procedure** you used.


## Contributing code

When contributing to ipython-startup-hook, please first discuss the change you wish to make via the [Issue Tracker](../issues) before writing any substantial code.
...
```shell
git clone https://github.com/<your username>/ipython-startup-hook
cd ipython-startup-hook
```
...
ipython-startup-hook uses [`conda`](https://conda.io/) to maintain a consistent development environment.
